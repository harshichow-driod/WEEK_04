...
public static <T extends Product<?>> void applyDiscount(T product, double
percentage) {
...
Product<ClothingCategory> shirt = new Product<>("Cotton Shirt", 799.0,
new ClothingCategory());
Product<GadgetCategory> phone = new Product<>("Smartphone", 14999.0,
new GadgetCategory());
